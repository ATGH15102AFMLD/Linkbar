...
begin
  ...
  try
    ...
    begin
      StackList := JclCreateThreadStackTraceFromID(False, FThreadID);
      if Assigned(StackList) then
      begin
...
begin
  ...
  begin
    ...
    JclStackTrackingOptions := JclStackTrackingOptions + [stDisableIfDebuggerAttached];
